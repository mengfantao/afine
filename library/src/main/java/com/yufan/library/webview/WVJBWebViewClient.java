package com.yufan.library.webview;
/**
 * open source https://github.com/jesse01/WebViewJavascriptBridge
 */
...
public class WVJBWebViewClient extends WebViewClient {
    ...
    void log(String action, Object json) {
        ...
        if (jsonString.length() > 500) {
            Log.d(kTag,kTag + " " + action + ": " + jsonString.substring(0, 500) + " [...]");
        } else {
            Log.d(kTag,kTag + " " + action + ": " + jsonString);
        }
    }
    ...
    private class MyJavascriptInterface {
        ...
        public void onResultForScript(String key, String value) {
            Log.d(kTag,kTag + " " + "onResultForScript: " + value);
