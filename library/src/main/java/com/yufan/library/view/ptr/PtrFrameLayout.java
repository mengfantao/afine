...
import com.yufan.library.view.ptr.util.PtrCLog;
...
public class PtrFrameLayout extends ViewGroup {
    ...
    private double mPagingTouchSlop;
    ...
    private void movePos(float deltaY) {
        ...
        updatePos(change);
        onUpdatePos(mPtrIndicator.getCurrentPosY()/3);
    }
    ...
    protected boolean onUpdatePos(int change) {
        return false;
    }
