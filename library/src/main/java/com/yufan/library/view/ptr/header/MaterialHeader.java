package com.yufan.library.view.ptr.header;
...
import com.yufan.library.view.ptr.PtrUIHandler;
import com.yufan.library.view.ptr.PtrUIHandlerHook;
import com.yufan.library.view.ptr.indicator.PtrIndicator;
...
public class MaterialHeader extends View implements PtrUIHandler {
    ...
    public MaterialHeader(Context context,PtrUIHandler ptrUIHandler) {
        super(context);
    ...
    public void onUIRefreshPrepare(PtrFrameLayout frame) {
        if(ptrUIHandler!=null){
            ptrUIHandler.onUIRefreshPrepare(frame);
        }
    }
    ...
    public void onUIRefreshBegin(PtrFrameLayout frame) {
        ...
        mDrawable.start();
        if(ptrUIHandler!=null){
            ptrUIHandler.onUIRefreshBegin(frame);
        }
    }
    ...
    public void onUIRefreshComplete(PtrFrameLayout frame) {
        mDrawable.stop();
        if(ptrUIHandler!=null){
            ptrUIHandler.onUIRefreshComplete(frame);
        }
    }
    ...
    public void onUIPositionChange(PtrFrameLayout frame, boolean isUnderTouch, byte status, PtrIndicator ptrIndicator) {
        ...
        if(ptrUIHandler!=null){
            ptrUIHandler.onUIPositionChange(frame,isUnderTouch,status,ptrIndicator);
        }
    }
}
